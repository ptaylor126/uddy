        ...
        <div className="right-panel">
          ...
          <div className="hero-composition">
            ...
            <div className="image-wrapper">
              ...
              {/* DOODLE OVERLAYS (Anchored to the tightly-fit wrapper) */}
      ...
      <style jsx global>{`
        ...
        * {
        ...
        .logo-text {
          ...
          color: #000;
          transform: scaleY(1.5); /* Massive vertical stretch */
        ...
        .bg-shape-pink {
          ...
          height: 100%;
          background-color: #F38AB6;
          /* Adjusted to start 25% down the left edge */
        ...
        .image-wrapper {
          position: relative;
          width: 50%; /* Tightly bounds the jars so doodles don't float away */
        ...
        .doodle-group-tl {
          top: -15%; left: -25%; width: 50%; aspect-ratio: 1; z-index: 10;
        }

        .doodle-group-tr {
          top: -20%; right: -25%; width: 50%; aspect-ratio: 1; z-index: 10;
        }

        .doodle-group-bl {
          bottom: -5%; left: -15%; width: 40%; aspect-ratio: 1; z-index: 10;
        }

        .doodle-group-br {
          bottom: -5%; right: -15%; width: 40%; aspect-ratio: 1; z-index: 10;
        }
        ...
        @media (max-width: 1024px) {
          ...
          .logo-text { font-size: 25vw; transform: scaleY(1); margin-bottom: 1rem; }
